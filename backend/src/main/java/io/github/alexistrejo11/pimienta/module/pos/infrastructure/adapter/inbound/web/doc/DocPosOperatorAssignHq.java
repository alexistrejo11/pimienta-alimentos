...
@Documented
@DocJwtSecured
@Operation(summary = "Assign operator to headquarter")
@RequestBody(
    required = true,
    content =
        @Content(
            mediaType = "application/json",
            schema = @Schema(implementation = AssignOperatorHeadquarterRequest.class)))
@ApiResponse(
    responseCode = "200",
...
public @interface DocPosOperatorAssignHq {}
