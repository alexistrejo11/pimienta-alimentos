...
public class PosShiftAdminUseCasesImpl implements PosShiftAdminUseCases {
  ...
  @Override public Page<PosShift> list(List<Long> hqs, Instant closedFrom, Instant closedTo, String status, Pageable page){
    return repository.findByHeadquarterIds(hqs, closedFrom, closedTo, status, page);
  }
