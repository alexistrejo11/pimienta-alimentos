...
WITH seed AS (
    ...
    FROM (VALUES
        ...
        (55, 'Chaparrita 250ml', '7500326103483', 15::numeric, 15::numeric, 0, 'Bebidas', 'CONTROLLED', TRUE),
        ...
        (103, 'Danone Fresas 220g', '7501032398576', 20::numeric, 20::numeric, 0, 'Bebidas', 'CONTROLLED', TRUE),
