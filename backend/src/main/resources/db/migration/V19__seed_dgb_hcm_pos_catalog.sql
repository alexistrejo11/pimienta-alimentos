...
-- Kitchen sections (Deli/Mexicano/Saludable/Japonesa/Paquete) stay as menu blocks;
-- retail categories split for cashier filtering (drinks, panaderia/galletas, botanas).
...
WITH seed AS (
    ...
    FROM (VALUES
        ...
        -- Bebidas preparadas
        (40, 'Jugo de Naranja', NULL, 30::numeric, 30::numeric, 0, 'Bebidas preparadas', 'NOT_CONTROLLED', TRUE),
        (41, 'Licuado De Platano', NULL, 35::numeric, 35::numeric, 5, 'Bebidas preparadas', 'NOT_CONTROLLED', TRUE),
        (42, 'Licuado de Fresa', NULL, 40::numeric, 40::numeric, 0, 'Bebidas preparadas', 'NOT_CONTROLLED', TRUE),
        (43, 'Licuado de Chocolate', NULL, 30::numeric, 30::numeric, 0, 'Bebidas preparadas', 'NOT_CONTROLLED', TRUE),
        (44, 'Cafe', NULL, 15::numeric, 15::numeric, 0, 'Bebidas preparadas', 'NOT_CONTROLLED', TRUE),
        (45, 'Cafe con Leche', NULL, 20::numeric, 20::numeric, 0, 'Bebidas preparadas', 'NOT_CONTROLLED', TRUE),
        (46, 'Chocolate Caliente', NULL, 30::numeric, 30::numeric, 0, 'Bebidas preparadas', 'NOT_CONTROLLED', TRUE),
        (47, 'Agua de Fruta 1lt', NULL, 25::numeric, 25::numeric, 5, 'Bebidas preparadas', 'NOT_CONTROLLED', TRUE),
        (124, 'Agua de Fruta 50ml', NULL, 15::numeric, 15::numeric, 5, 'Bebidas preparadas', 'NOT_CONTROLLED', TRUE),
        -- Agua (+ hidratacion)
        (52, 'Bonafont 1lt', '758104100422', 15::numeric, 15::numeric, 0, 'Agua', 'CONTROLLED', TRUE),
        (53, 'Bonafont 600ml', '758104001712', 10::numeric, 10::numeric, 10, 'Agua', 'CONTROLLED', TRUE),
        (104, 'Agua Purificada Kirkland 500ml', '096619536740', 10::numeric, 10::numeric, 0, 'Agua', 'CONTROLLED', TRUE),
        (60, 'Electrolit', '7501125118562', 25::numeric, 25::numeric, 0, 'Agua', 'CONTROLLED', TRUE),
        (107, 'Suerox Naranja Mandarina', '650240032301', 25::numeric, 25::numeric, 5, 'Agua', 'CONTROLLED', TRUE),
        (108, 'Suerox Fresa Kiwi', '650240032264', 25::numeric, 25::numeric, 5, 'Agua', 'CONTROLLED', TRUE),
        (109, 'Suerox', '650240035395', 25::numeric, 25::numeric, 5, 'Agua', 'CONTROLLED', TRUE),
        (110, 'Suerox Uva', '650240032271', 25::numeric, 25::numeric, 5, 'Agua', 'CONTROLLED', TRUE),
        -- Jugos
        (50, 'Boing de Guayaba 500ml', '75003135', 25::numeric, 25::numeric, 5, 'Jugos', 'CONTROLLED', TRUE),
        (111, 'Boing de Mango 500ml', '75003104', 25::numeric, 25::numeric, 5, 'Jugos', 'CONTROLLED', TRUE),
        (112, 'Boing de Fresa', '75003166', 25::numeric, 25::numeric, 5, 'Jugos', 'CONTROLLED', TRUE),
        (113, 'Boing de Manzana', '75003159', 25::numeric, 25::numeric, 5, 'Jugos', 'CONTROLLED', TRUE),
        (51, 'Arizona 570ml', '613008772901', 30::numeric, 30::numeric, 5, 'Jugos', 'CONTROLLED', TRUE),
        (114, 'Arizona de Mango 570ml', '613008772963', 30::numeric, 30::numeric, 5, 'Jugos', 'CONTROLLED', TRUE),
        (115, 'Arizona de Ponche de Frutas', '613008772871', 30::numeric, 30::numeric, 5, 'Jugos', 'CONTROLLED', TRUE),
        (116, 'Arizona de Sandia 570ml', '613008772840', 30::numeric, 30::numeric, 5, 'Jugos', 'CONTROLLED', TRUE),
        (55, 'Chaparritta Mandarina Sin Gas 250ml', '7500326103483', 15::numeric, 15::numeric, 0, 'Jugos', 'CONTROLLED', TRUE),
        (134, 'Chaparritta Piña Sin Gas 250ml', '7500326103490', 15::numeric, 15::numeric, 0, 'Jugos', 'CONTROLLED', TRUE),
        (135, 'Chaparritta Guayaba Sin Gas 250ml', '7503029481803', 15::numeric, 15::numeric, 0, 'Jugos', 'CONTROLLED', TRUE),
        (58, 'Te Verde Kirklannd', '096619757572', 25::numeric, 25::numeric, 0, 'Jugos', 'CONTROLLED', TRUE),
        -- Refrescos
        (54, 'Peñafiel 600ml', '7501073839854', 25::numeric, 25::numeric, 0, 'Refrescos', 'CONTROLLED', TRUE),
        (56, 'Coca Zero 600ml', '7501055320639', 25::numeric, 25::numeric, 0, 'Refrescos', 'CONTROLLED', TRUE),
        (57, 'Coca 600ml', '75007614', 25::numeric, 25::numeric, 0, 'Refrescos', 'CONTROLLED', TRUE),
        (59, 'Sangría Señorial', '7500326103360', 25::numeric, 25::numeric, 0, 'Refrescos', 'CONTROLLED', TRUE),
        -- Lacteos
        (103, 'Yogurt Danone Fresa 220g', '7501032398576', 20::numeric, 20::numeric, 0, 'Lacteos', 'CONTROLLED', TRUE),
        (132, 'Yogurth Danone Mango 220g', '7506443108592', 20::numeric, 20::numeric, 0, 'Lacteos', 'CONTROLLED', TRUE),
        (131, 'Leche Yomi LaLa Chocolate 400ml', '7501020570854', 20::numeric, 20::numeric, 0, 'Lacteos', 'CONTROLLED', TRUE),
        (133, 'Leche Nesquik Nestle 185ml', '7506475117876', 20::numeric, 20::numeric, 0, 'Lacteos', 'CONTROLLED', TRUE),
        -- Panaderia (pan, panques, donas, muffins, pastelitos)
        (61, 'Mantecadas de Nuez Bimbo', '7501030419389', 25::numeric, 25::numeric, 0, 'Panaderia', 'CONTROLLED', TRUE),
        (62, 'Mantecadas de Vainilla Bimbo', '7501000112401', 25::numeric, 25::numeric, 5, 'Panaderia', 'CONTROLLED', TRUE),
        ...
        -- Galletas
        (69, 'Tartinas con Fresa Tía Rosa', '7500810015261', 25::numeric, 25::numeric, 0, 'Galletas', 'CONTROLLED', TRUE),
        (70, 'Tartinas con Piña Tía Rosa', '7500810016190', 25::numeric, 25::numeric, 0, 'Galletas', 'CONTROLLED', TRUE),
        (74, 'Príncipe de Chocolate', '7500810011126', 30::numeric, 30::numeric, 0, 'Galletas', 'CONTROLLED', TRUE),
        (83, 'Principe Rees Marinela', '7500810044056', 30::numeric, 30::numeric, 5, 'Galletas', 'CONTROLLED', TRUE),
        (85, 'Principe Chocolate Blanco', '7500810011140', 25::numeric, 25::numeric, 0, 'Galletas', 'CONTROLLED', TRUE),
        (87, 'Principe de Limon Marinela', '7500810011157', 30::numeric, 30::numeric, 0, 'Galletas', 'CONTROLLED', TRUE),
        (75, 'Deliciosas de Vainilla Lara', '7501030463740', 25::numeric, 25::numeric, 0, 'Galletas', 'CONTROLLED', TRUE),
        (86, 'Deliciosas con sabor de chispas de chocolate Lara', '7501030463726', 25::numeric, 25::numeric, 0, 'Galletas', 'CONTROLLED', TRUE),
        (76, 'Canelitas Marinela', '7500810022801', 30::numeric, 30::numeric, 0, 'Galletas', 'CONTROLLED', TRUE),
        (77, 'Baritas De Fresa Marinela', '7500810014721', 25::numeric, 25::numeric, 0, 'Galletas', 'CONTROLLED', TRUE),
        (78, 'Baritas De Pina Marinela', '7500810014738', 25::numeric, 25::numeric, 5, 'Galletas', 'CONTROLLED', TRUE),
        (88, 'Triki Trakes Marinela', '7501000140855', 30::numeric, 30::numeric, 0, 'Galletas', 'CONTROLLED', TRUE),
        (89, 'Pastisetas Suandy', '7500810031278', 35::numeric, 35::numeric, 0, 'Galletas', 'CONTROLLED', TRUE),
        (118, 'Galleta de Macadamia Kirkland', '4665610000008', 20::numeric, 20::numeric, 5, 'Galletas', 'CONTROLLED', TRUE),
        (119, 'Galleta de Chocolate Kirkland', '4542655000005', 20::numeric, 20::numeric, 5, 'Galletas', 'CONTROLLED', TRUE),
        -- Dulces
        ...
        (126, 'Halls Cere', '7622210267825', 15::numeric, 15::numeric, 5, 'Dulces', 'CONTROLLED', TRUE),
        ...
        (130, 'Dulce Mexicano', NULL, 10::numeric, 10::numeric, 0, 'Dulces', 'NOT_CONTROLLED', TRUE),
        (121, 'Chicle Menta  Orbit', '75039394', 5::numeric, 5::numeric, 5, 'Dulces', 'CONTROLLED', TRUE),
        (122, 'Chicle de Fresa Bubbalo', '75073244', 4::numeric, 4::numeric, 5, 'Dulces', 'CONTROLLED', TRUE),
        (125, 'Chicle Orbit Polar Mint', '75040437', 5::numeric, 5::numeric, 5, 'Dulces', 'CONTROLLED', TRUE),
        -- Botanas
        (102, 'Cacahuate Japones Nishikawa 60g', '7501308300074', 15::numeric, 15::numeric, 0, 'Botanas', 'CONTROLLED', TRUE)
    ) AS v(
        ord,
        name,
        barcode,
