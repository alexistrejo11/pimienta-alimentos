...
const recentCommits = [
  {
    hash: '2bde20a',
    message: 'feat(global): publish APK and integrate it into the web environment',
    date: new Date('2026-09-10'),
  },
  {
    hash: 'f16643c',
    message: 'feat(pos): add HQ ACL, web central, stock projection, and Android B7',
        ...
        highlightedFeatures: [
          {
            ...
            description: 'One suite covers staff, HR, CRM, payroll, contracts, inventory, and operational work.',
          },
          {
            icon: 'point_of_sale',
            label: 'Cafeteria POS',
            description: 'A local-first Android POS supports school-cafeteria sales and later synchronization.',
          },
          {
            icon: 'sync',
            label: 'Connected Platforms',
            description: 'Web, API, and POS exchange operational data through explicit authenticated flows.',
          },
        ],
      },
    },
            ...
            highlightedFeatures: [
              {
                ...
                description: 'The site presents company information, quality commitments, and legal notices.',
              },
              {
                icon: 'dashboard',
                label: 'Staff Workspace',
                description: 'Authenticated staff manage operational areas from a role-aware workspace.',
              },
              {
                icon: 'point_of_sale',
                label: 'POS Central',
                description: 'Administrators manage cafeterias, devices, catalog data, incidents, and reports.',
              },
            ],
            highlightedCommand: {
            ...
            highlightedFeatures: [
              {
                ...
                description: 'JWT authentication and headquarters access rules protect staff and POS administration.',
              },
              {
                icon: 'inventory_2',
                label: 'Operational Domains',
                description: 'Dedicated modules support the company workforce, commercial, and inventory workflows.',
              },
              {
                icon: 'sync',
                label: 'POS Synchronization',
                description: 'Device enrollment, bootstrap, changes, and idempotent event ingestion connect cafeterias.',
              },
            ],
            highlightedCommand: {
            ...
            highlightedFeatures: [
              {
                ...
                description: 'Sales are recorded in a device database before the central API is contacted.',
              },
              {
                icon: 'manage_accounts',
                label: 'Device Operations',
                description: 'Enrollment, operator access, cash opening, and manager controls are built into the app.',
              },
              {
                icon: 'sync',
                label: 'Resilient Sync',
                description: 'A constrained background worker uploads POS events and recovers from stale cursors.',
              },
            ],
            highlightedCommand: {
