...
abstract class PosDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun create(context: Context, databaseName: String = "pimienta-pos.db"): PosDatabase = Room.databaseBuilder(
            ...
            databaseName
         ).addMigrations(Migrations.V1_TO_V2, Migrations.V2_TO_V3, Migrations.V3_TO_V4, Migrations.V4_TO_V5, Migrations.V5_TO_V6, Migrations.V6_TO_V7, Migrations.V7_TO_V8).build()
    }
}
