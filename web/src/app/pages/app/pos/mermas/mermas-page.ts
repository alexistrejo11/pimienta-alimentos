...
@Component({
  ...
  imports: [PageHeaderComponent, DataStateComponent, FormsModule, DatePipe, JsonPipe],
  templateUrl: './mermas-page.html',
})
export class MermasPageComponent implements OnInit {
